...
; (function ($) {
  ...
  var RENDERAPI = {
    ...
    sideBarTpl: function (button) {
      var html = '<span class="c-datepicker-picker__sidebar">' +
        '</span>';
      return html;
    },
    pickerFooterTpl: function (nameOptions, className, text) {
      var html = '<div class="c-datepicker-picker__footer" style="">' +
        ...
        '</span>' +
        '</button>' +
        '<button type="button" id="only" class="c-datepicker-button c-datepicker-picker__link-btn confirm c-datepicker-button--default c-datepicker-button--mini is-plain">' +
        '<span>' +
        nameOptions.confirm +
        '</span>' +
        '</button>' +
